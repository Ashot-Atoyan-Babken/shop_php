...
<body>
   ...
   <div class="mx-auto text-center mt-5 w-25 pb-5 pt-3"
      style="border:1px solid #000; border-radius: 15px; box-shadow: 0px 0px 33px 0px rgba(0,0,0,1)">
      <h4 class=" mb-4 pb-3 text-success text-uppercase">category</h4>
      <div class="form-group ">
         <input type="text" name="category_title" style="border-radius: 15px;" class="form-style text-center w-75"
            id="category" placeholder="Your Category" autocomplete="off">
         <i class="input-icon uil uil-list-ul"></i>
      </div>
      <input class="btn mt-4 btn-info category" style="border-radius: 15px;" type="submit" value="Create category"
         name="category">
   </div>
      ...
      <tbody>
         ...
         <tr>
            ...
            <td class="text-center">
               <a href="view/product.php?id=<?= $category['id'] ?>" class="btn btn-info open_prod" target="_blank"
                  data-id="<?= $category['id'] ?>">OPEN</a>
