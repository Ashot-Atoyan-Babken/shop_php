      ...
      <table class="table table-hover mx-auto mt-5" style="width: 80%; border:1px solid #000">
         ...
         <tbody>
            ...
            foreach ($orders as $order) { ?>
               <tr>
                  <td><img src="../asset/img/products/<?= $order['product_image'] ?>" alt="<?= $order['product_image'] ?>" style="width: 150px; height: 150px"></td>
                  ...
                  <td><button class="btn btn-info confirm" type="button" data-id="<?= $order['product_id'] ?>" <?= $disabled ?>>Confirmed</button></td>
               </tr>
            <?php  } ?>
         </tbody>
      </table>
      ...
      <table class="table table-hover mx-auto mt-5" style="width: 80%; border:1px solid #000">
         ...
         <tbody>
            ...
            foreach ($transmitted_orders as $orders) { ?>
               <tr>
                  <td><img src="../asset/img/products/<?= $orders['product_image'] ?>" alt="<?= $orders['product_image'] ?>" style="width: 150px; height: 150px"></td>
