...
<body>
   ...
   include 'header.php';
   ?>
   <div class="mx-auto mt-5 w-25 p-3"
      ...
      <tbody>
         ...
         <tr>
            ...
            <td class="text-center">
               <button type="button" class="btn btn-primary edit_prod" data-id="<?= $product['product_id'] ?>"
                  data-toggle="modal" data-target="#Modal">
                  EDIT
               </button>
               <button type="button" class="btn btn-danger delete_prod"
