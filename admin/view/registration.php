                           ...
                           <div class="center-wrap">
                              <div class="section text-center">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="alert alert-danger" role="alert" id="username_alert"
                                       style="display:none;"></div>
                                 </div>
                                 <div class="form-group mt-2">
                                    <input type="email" name="your_email" class="form-style" placeholder="Your Email"
                                       id="your_email" autocomplete="off">
                                 ...
                                 <div class="form-group mt-2">
                                    <input type="password" name="comfirm_password" class="form-style"
                                       placeholder="Comfirm Password" id="comfirm_password" autocomplete="off">
                                    <i class="input-icon uil uil-lock-alt"></i>
                                    <div class="alert alert-danger" role="alert" id="comf_pass_alert"
                                       style="display:none;"></div>
                                 </div>
                                 <input class="btn mt-4 btn-dark register" type="submit" value="Register"
                                    name="register">
